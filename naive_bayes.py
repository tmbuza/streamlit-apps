...
st.title("Naive Bayes Classifier Model")
st.write("""
This app demonstrates a Naive Bayes classifier using synthetic data. 
...
In this section, we visualize the decision boundary of the Naive Bayes classifier in 2D space.
...
For a deeper understanding of the Naive Bayes technique and other machine learning models, check out the full **Practical Guide to Mastering Machine Learning Techniques**.

[Read the full practical guide here](https://complexdatainsights.com//machine-learning/chapter8)
